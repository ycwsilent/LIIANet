...
def option():
    ...
    # parser.add_argument('--cropSize', type=int, default=320, help='image crop size (patch size)')
    ...
    parser.add_argument('--snapshots', type=int, default=10, help='Snapshots for save checkpoints pth')         # 多少轮进行权重保存
