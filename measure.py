...
if __name__ == '__main__':
    ...
    if mea.lol:
        ...
        # im_dir = './otherResult/DarkIR-results/LOLv1/*.png'
        # im_dir = '/home/usertwo/ycw/projects/otherMethods/Results/24-iconip-RetinexMamba/RetinexMamba_LOL_v1/*.png'
        label_dir = './datasets/LOLdataset/eval15/high/'
    if mea.lol_v2_real:
        im_dir = './output/LOLv2_real/*.png'
        # im_dir = '/home/usertwo/ycw/projects/otherMethods/Results/24-iconip-RetinexMamba/RetinexMamba_LOL_v2_real/*.png'
        label_dir = './datasets/LOLv2/Real_captured/Test/Normal/'
    if mea.lol_v2_syn:
        # im_dir = './output/LOLv2_syn/*.png'
        # im_dir = '/home/usertwo/ycw/projects/otherMethods/Results/24-iconip-RetinexMamba/RetinexMamba_LOL_v2_synthetic/*.png'
        im_dir = './output/LOLv2_syn/*.png'
